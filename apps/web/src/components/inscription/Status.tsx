    ...
    <div className="w-full flex flex-row justify-center items-center mt-10 mb-2">
      ...
      <div className="flex flex-col items-center">
        <div className={`InscriptionStatus__dot${requestClass} w-2 h-2 rounded-full relative`}>
          <p className={`InscriptionStatus__text${requestClass} text-xs text-wrap w-[4rem] text-center absolute top-[100%] left-[-2rem] origin-center`}>Requested on Starknet</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center">
        <div className={`InscriptionStatus__dot${waitingClass} w-2 h-2 bg-gray-400 rounded-full relative`}>
          <p className={`InscriptionStatus__text${waitingClass} text-xs text-wrap w-[4rem] text-center absolute top-[100%] left-[-2rem] origin-center`}>Waiting for Inscriptor</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center">
        <div className={`InscriptionStatus__dot${inscriptorClass} w-2 h-2 bg-gray-400 rounded-full relative`}>
          <p className={`InscriptionStatus__text${inscriptorClass} text-xs text-wrap w-[4rem] text-center absolute top-[100%] left-[-2rem] origin-center`}>Inscriptor Accepted</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center">
        <div className={`InscriptionStatus__dot${bitcoinClass} w-2 h-2 bg-gray-400 rounded-full relative`}>
          <p className={`InscriptionStatus__text${bitcoinClass} text-xs text-wrap w-[4rem] text-center absolute top-[100%] left-[-2rem] origin-center`}>Inscribing on Bitcoin</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center">
        <div className={`InscriptionStatus__dot${completeClass} w-2 h-2 bg-gray-400 rounded-full relative`}>
          <p className={`InscriptionStatus__text${completeClass} text-xs text-wrap w-[4rem] text-center absolute top-[100%] left-[-2rem] origin-center`}>Request Complete</p>
        </div>
      </div>
      <div className="mx-1 flex-grow h-0.5 rounded-lg"></div>
    </div>
