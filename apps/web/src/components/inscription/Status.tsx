...
function InscriptionStatus() {
  return (
    <div className="w-full flex flex-row justify-center items-center mt-10 mb-2">
      ...
      <div className="mx-2 flex-grow h-0.5 bg-gray-400 rounded-lg InscriptionStatus__line--active"></div>
      <div className="flex flex-col items-center">
        <div className="InscriptionStatus__dot--pending w-2 h-2 rounded-full relative">
